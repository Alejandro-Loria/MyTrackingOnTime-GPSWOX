...
namespace MyTrackingOnTime.Models
{
    public class DevicesModel
    {
        public class Token
        {
            ...
            public string UserApiHash { get; set; }
        ...
        [Display(Name = "Colores de Iconos")]
        ...
        [Display(Name = "Datos del Dispositivo")]
        ...
        public class Currents
        {
            ...
            public List<object> Geofences { get; set; }
        }
